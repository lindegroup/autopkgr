...
- (NSString *)newSoftwareString
{
    ...
    if (downloadList.count) {
        ...
        string = [@"New software available for testing".html_H3 mutableCopy];
...
- (NSString *)runFailuresString
{
    ...
    if (failures.count) {
        string = [@"The following failures occurred.".html_H3 mutableCopy];
    ...
    if (_error) {
        ...
        for (NSString *errString in recoverySuggestions.removeEmptyStrings) {
            ...
            if (![failures filteredArrayUsingPredicate:failurePredicate].count) {
                if (!string) {
                    string = [@"The following errors occurred:".html_H3 mutableCopy];
                }
