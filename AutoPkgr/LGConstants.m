...
NSString *const kSMTPEncryption = @"SMTPEncryption";
...
NSString *const kStatusAvailableImage = @"NSStatusAvailable";
NSString *const kStatusUnavailableImage = @"NSStatusUnavailable";
